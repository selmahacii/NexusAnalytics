...
export async function GET(request: NextRequest) {
  try {
    ...
    const macroIndicators = [
      { country: "Algeria", gdpGrowth: 3.2, inflation: 9.3, tradeBalance: 12.5e9, year: 2024 },
      { country: "Tunisia", gdpGrowth: 1.5, inflation: 10.2, tradeBalance: -2.1e9, year: 2024 },
      { country: "Morocco", gdpGrowth: 2.8, inflation: 4.5, tradeBalance: -5.4e9, year: 2024 },
      { country: "Italy", gdpGrowth: 0.7, inflation: 5.9, tradeBalance: 4.8e9, year: 2024 },
      { country: "France", gdpGrowth: 0.9, inflation: 5.1, tradeBalance: -8.2e9, year: 2024 },
      { country: "Spain", gdpGrowth: 2.1, inflation: 3.6, tradeBalance: -1.4e9, year: 2024 },
    ];

    // ── Weather Forecast (Mocking Open-Meteo for Algiers) ──
    ...
    const exchangeRates = [
      { pair: "USD/DZD", rate: 134.52, change24h: 0.15, lastUpdated: new Date().toISOString() },
      { pair: "EUR/DZD", rate: 145.88, change24h: -0.22, lastUpdated: new Date().toISOString() },
      { pair: "GBP/DZD", rate: 170.12, change24h: 0.08, lastUpdated: new Date().toISOString() },
      { pair: "EUR/USD", rate: 1.0845, change24h: 0.12, lastUpdated: new Date().toISOString() },
    ];
